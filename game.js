...
(function () {
  ...
  function resize() {
    ...
    CW = cutsceneCanvas.clientWidth = cutsceneCanvas.parentElement.clientWidth;
    CH = cutsceneCanvas.clientHeight = cutsceneCanvas.parentElement.clientHeight;
  ...
  document.getElementById("btn-start").addEventListener("pointerdown", (e) => {
    e.stopPropagation(); ensureAudio(); beginStory();
  });
